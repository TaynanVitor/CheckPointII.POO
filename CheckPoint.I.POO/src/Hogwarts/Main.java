...
//        Casas = new Casas("Todos os alunos");
        ...
        Alunos aluno4 = new Alunos("joao", "França", 100, 4, 7, "poções");
        Alunos aluno5 = new Alunos("Ravena", "Italia", 50, 5, 7, "quadribol");
        Alunos aluno6 = new Alunos("Lili", "Londres", 250, 6, 7, "defesa contra a arte das trevas");
        Alunos aluno7 = new Alunos("Roger", "França", 100, 7, 7, "poções");
        ...
        Alunos aluno10 = new Alunos("Enola", "Espanha", 100, 10, 7, "herbologia");
        Alunos aluno11 = new Alunos("Rubio", "India", 220, 11, 7, "quadribol");
        Alunos aluno12 = new Alunos("Ferdinando", "França", 0, 12, 7, "defesa contra a arte das trevas");
        Alunos aluno13 = new Alunos("Rouina", "Londres", 100, 13, 7, "quadribol");
        ...
        Alunos aluno16 = new Alunos("Lucas", "Londres", 80, 16, 7, "herbologia");
        Alunos aluno17 = new Alunos("Diana", "Londres", 50, 17, 7, "defesa contra a arte das trevas");
        Alunos aluno18 = new Alunos("Robson", "Londres", 100, 18, 7, "poções");
        Alunos aluno19 = new Alunos("Giulia", "Londres", 100, 19, 7, "quadribol");
        Alunos aluno20 = new Alunos("Roberto", "Londres", 230, 20, 7, "herbologia");
