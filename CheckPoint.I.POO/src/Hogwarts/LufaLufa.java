...
public class LufaLufa extends Alunos{
    public LufaLufa(String nome, String endereco, Integer pontuacao, LocalDate idade, Byte anoLetivo, String disciplinaDestaque, Integer matricula){
    ...
    public LufaLufa(String nome, String endereco, Integer pontuacao, LocalDate idade, Byte anoLetivo, String disciplinaDestaque, Integer matricula, String orientador, Integer qtdAlunos, Integer pontuacaoCasa, Integer especialidade) {
        super(nome, endereco, pontuacao, idade, anoLetivo, disciplinaDestaque, matricula);
